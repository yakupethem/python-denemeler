...
tus_topla = Button(text="+", font="20",width=2, command=lambda :topla()).place(x=20, y=40)
tus_cikar = Button(text="-", font="20",width=2, command=lambda :cikar()).place(x=50, y=40)
tus_carp = Button(text="*", font="20",width=2, command=lambda :carp()).place(x=80, y=40)
tus_bol = Button(text="/", font="20",width=2, command=lambda :bol()).place(x=110, y=40)
